...
export const FIXED_EXTERNAL_SERVICE = 'pastepile.com';
export const FIXED_EXTERNAL_ENDPOINT = 'https://www.pastepile.com/api/public/pastes';
...
export function verifyPortableReceipt(receipt) {
  const required = [
    ...
    'executor_id', 'executor_revision', 'policy', 'observed', 'receipt_hash'
  ];
